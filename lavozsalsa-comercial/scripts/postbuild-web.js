...
const GA_MEASUREMENT_ID = process.env.LVS_COMERCIAL_GA4_ID || process.env.LVS_PREMIUM_GA4_ID || process.env.LVS_GA4_ID || 'G-8C6LP4VJSY';
const GOOGLE_SITE_VERIFICATION =
  process.env.LVS_COMERCIAL_GOOGLE_SITE_VERIFICATION || process.env.LVS_PREMIUM_GOOGLE_SITE_VERIFICATION || process.env.LVS_GOOGLE_SITE_VERIFICATION || '';
